...
export class HelpUI {
    ...
    update(ctx) {
        ...
        const lines = [
            ...
            "M           — place maneuver node near cursor",
            "Shift+N     — clear all maneuver nodes",
            "Enter       — focus chat",
            "Mouse wheel — zoom / adjust maneuver Δv",
            "Esc         — toggle menu",
            "H           — toggle this help",
            "",
            ...
            "",
            "MANEUVER NODES",
            "Press M with prediction active to place a node on your",
            "trajectory near the cursor. Each node shows a panel with",
            "orientation buttons (Pro, Ret, Nrm, Anti, RIn, ROut, Man)",
            "and Δv magnitude controls.",
            "Hold Man and move the mouse to aim the burn manually.",
            "Scroll wheel over a node to adjust its Δv.",
            "Auto:ON makes your ship execute the burn automatically.",
            "Two ghosts are shown: cyan = ideal post-burn path,",
            "green = physical burn demonstration.",
        ];
        ctx.font = `${State.textCharacterSize}px ui-monospace, SFMono-Regular, "Menlo", monospace`;
        ctx.textBaseline = "top";
        ctx.textAlign = "left";
