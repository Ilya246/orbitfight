...
struct Triangle: public Entity {
	...
	double accel = 0.008, rotateSpeed = 2.0, boostCooldown = 12.0, boostStrength = 1.5, reload = 6.0, shootPower = 2.0, hyperboostStrength = 0.06, hyperboostTime = 15.0 * 60.0, hyperleapStrengh = 60.0,
