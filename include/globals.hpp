...
inline double delta = 1.0 / 60.0,
	...
	gen_extraStarChance = 0.3, gen_blackholeChance = 1.0 / 3.0, gen_starMass = 2.0e24, gen_starRadius = 3.0e5,
	gen_firstPlanetDistance = 6.0e5, gen_minNextRadius = 1.1, gen_maxNextRadius = 1.25, gen_minPlanetRadius = 300.0, gen_maxPlanetRadius = 12000.0,
	gen_baseDensity = 5e10, gen_densityFactor = 2.5,
