...
inline double delta = 1.0 / 60.0,
	...
	gen_firstPlanetDistance = 6.0e5, gen_minNextRadius = 1.1, gen_maxNextRadius = 1.25, gen_minPlanetRadius = 300.0, gen_maxPlanetRadius = 10000.0,
...
nextID = 0,
predictSteps = (int)(30.0 / predictDelta),
